...
1. [TanStack Start](#1-tanstack-start) (HIGH)
  - 1.1 [Keep the module in a -stem folder beside the route file](#11-keep-the-module-in-a--stem-folder-beside-the-route-file)

## 1. TanStack Start

### 1.1 Keep the module in a -stem folder beside the route file
